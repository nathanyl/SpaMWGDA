...
# from utils import features_construct_graph, spatial_construct_graph1, spatial_construct_graph
import os
import argparse
...
def load_ST_file(dataset, highly_genes, k, radius):
    ...
    sadj_a, graph_nei_a, graph_neg_a = spatial_construct_graph(adata.X, k=k)
...
if __name__ == "__main__":
    ...
    for i in range(len(datasets)):
        ...
        print("saving")
        adata.write(savepath + 'SpaMGCN.h5ad')
        print("done")
