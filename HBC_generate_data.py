...
def load_ST_file(dataset, highly_genes, k, radius):
    ...
    fadj = features_construct_graph(feat, k=k)
    sadj, graph_nei, graph_neg = spatial_construct_graph(adata.obsm['spatial'], k=k)
    sadj_a, graph_nei_a, graph_neg_a = spatial_construct_graph1(adata, radius=radius)
